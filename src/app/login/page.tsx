...
import { Shield, Lock, Mail, Eye, EyeOff, AlertTriangle, ArrowRight, ArrowLeft, KeyRound } from 'lucide-react';
...
export default function LoginPage() {
  ...
  const handleMfaDigitChange = useCallback((index: number, value: string) => {
    ...
    if (digit && index === 5) {
      ...
      if (code.length === 6) {
        ...
        setTimeout(() => {
          const submitCode = newDigits.join('');
          if (submitCode.length === 6) {
            handleMfaSubmitAuto(submitCode);
          }
        }, 100);
      }
    }
  ...
  const handleMfaSubmitAuto = async (code: string) => {
    setError('');
    setLoading(true);
        ...
        {step === 'credentials' && (
          <form onSubmit={handleLogin} className="space-y-5">
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  style={{ background: '#1a1f36', border: '1px solid #374151', focusRingColor: '#f59e0b' }}
            ...
            <div className="text-center pt-2">
              ...
              <span className="text-sm cursor-pointer" style={{ color: '#f59e0b' }}>Registrarse</span>
            </div>
          </form>
        )}
